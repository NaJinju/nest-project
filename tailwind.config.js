...
module.exports = {
  content: ['./src/views/**/*.{html,js,hbs}', './src/**/*.{html,js,hbs}'],
  theme: {
    container: {
      center: true,
    },
    extend: {
      ...
      boxShadow: {
        'box-sw-01': '0px 1px 6px rgba(0, 0, 0, 0.06);',
        'box-sw-02': '0px 5px 25px rgba(0, 0, 0, 0.18);',
        'box-sw-03': 'inset 0px 4px 4px rgba(0, 0, 0, 0.14);',
        'box-sw-04': '0px 1px 8px rgba(0, 0, 0, 0.05)',
      },
    },
    screens: {
      md: { max: '767px' },
